                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="fn" id="inputEmail" placeholder="" required  value="<?php echo isset($firstname) ? $firstname : "" ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Tên đệm</label>
                                    <div class="controls">
                                        <input type="text" name="ln" id="inputEmail" placeholder="" value="<?php echo isset($lastname) ? $lastname : "" ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Tên</label>
                                    <div class="controls">
                                        <input type="text" name="mn" id="inputEmail" placeholder="" value="<?php echo isset($middle_name) ? $middle_name : "" ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">

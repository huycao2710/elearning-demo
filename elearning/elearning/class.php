...
<body>
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span9">
                <a href="" class="btn btn-success"><i class="icon-group icon-large"></i>&nbsp;<?php echo getCountStudentClass($id_class, $conn, $session_id) ?></a>
                <br><br>
                        ...
                        <div class="span7">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td><a href="">&nbsp;<i class="icon-user icon-large"></i>&nbsp;<?php echo $student_row['firstname'] . " " . $student_row['lastname']. " " . $student_row['middle_name']; ?></a></td>

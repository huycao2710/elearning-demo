        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <!-- <?php if($id_class !== -1) : ?>
                        <li>
                                <a href="submit.php?id=<?php echo $id_class ?>"><i class="icon-home icon-large"></i>&nbsp;Submit
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a>
            ...
            <div class="span9">
                ...
                <div class="alert">Class:<a href="" >&nbsp;<strong><?php echo $row_class['course_id']; ?></strong></a>
                    ...
                    &nbsp;
                    Teacher:<a href="">&nbsp;<strong><?php echo $teacher_row['firstname']." ".$teacher_row['lastname'] . " " . $teacher_row['middlename']; ?></strong></a>
                </div>

<?php
    ...
    function getCountStudentClass($class_id, $conn, $session_id) {
        $result = mysqli_query($conn,"select * from sws where teacher_id='$session_id' and class_id='$class_id'") or die(mysqli_error());
...
<html lang="en">
    ...
    ?>
        <title>HAU Elearning </title>
        <link href="admin/img/hauicon.png" rel="icon" type="image">

        ...
        <div class="row-fluid">
            <div class="span10">
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Login Student!</strong>&nbsp;Nhập thông tin 
                </div>
            ...
            <div class="span2">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li><a href="#"><i class="icon-book icon-large"></i>&nbsp;Nhiệm vụ</a></li>
                        <li><a href="#"><i class="icon-book icon-large"></i>&nbsp;Lời hứa</a></li>
                        <li><a href="#"><i class="icon-list-alt icon-large"></i>&nbsp;Lịch sử</a></li>

                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <td><?php echo $student_row['firstname'] . " " . $student_row['lastname'] . " " . $student_row['middle_name']; ?></td>
                            ...
                            <div id="view<?php echo $student_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="span12">
                                        <div class="span6">
                                            <p>  Name:&nbsp;<strong><?php echo $student_row['firstname'] . " " . $student_row['lastname'] . " " . $student_row['middle_name']; ?></strong> </p>
                                        </div>
                                        <div class="span6">

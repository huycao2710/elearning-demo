                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <td><a rel="tooltip"  title="View Class" id="v<?php echo $class_id; ?>"  href="class.php<?php echo '?id='.$class_id; ?>" class="btn btn-info">&nbsp;<i class="icon-group icon-large"></i>&nbsp;<?php echo getCountStudentClass($class_id, $conn, $session_id) ?></a></td>

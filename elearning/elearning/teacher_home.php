        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li>
                            <a href="teacher_class.php"><i class="icon-group icon-large"></i>&nbsp;Lớp học
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
                        <li><a href="teacher_subject.php"><i class="icon-file-alt icon-large"></i>&nbsp;Môn học
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Xin Chào !</strong>&nbsp;Chào Mừng đến với HAU Elearning
                </div>
